...
$pictures=$picturesManager->loadByTags(
    ...
    'pictures_to_plot_events.priority'
);

$cover_photo_id = $picturesManager->getCoverPhotoByTag('pictures_to_plot_events', 'plot_events_id', $plot_event->get_id());
...
<div id="photos">
    ...
    if( isset($pictures) && count($pictures) > 0 )
    {
        foreach($pictures as $picture)
        {
            ...
            ?>
            <div id="plot_<?=$picture->get_id()?>" class="photo-wrapper <?= $is_cover_photo ? 'cover_photo' : ''?>">
                ...
                <div class="photo-menu-wrapper">
                    ...
                    <div id="photo-menu-<?=$picture->get_id()?>" class="photo-menu">
                        <ul>
                            ...
                            <li onclick="makeCoverPhoto('<?=$picture->get_id()?>', '<?=$plot_event->get_id()?>', 'plot');">
