...
$settingsModel=$settingsManager->loadModel($currentStory->get_series()->get_id());
//$characters = $charactersManager->loadAll();
//var_dump($characters);

$groups = $settingsModel->get_groups();
?>
<p>Setting Models let you specify every detail that define your settings. </p>
<p>This model applies to every setting in the current story (and stories in the same series). </p>
        ...
        <tr>
            <th colspan="7" align="left">
                ...
                <div style="float:right">
                    <form id="groupAdd" action="/settings/ajax/" method="post">
							...
							<thead >
								<tr>
									<th class="group_name">
										...
										<span class="edit">
											<form id="groupEdit_<?php echo ( $group->get_id() ); ?>" action="/settings/ajax/" method="post" onsubmit="return false;" class="group_edit">
										...
										?>
											<tr id="fields_<?php echo $field->get_id() ?>" class="<?php echo $class ?>">
												<td class="field_name">
													...
													<span class="edit">
														<form id="fieldEdit_<?php echo ( $field->get_id() ); ?>" action="/settings/ajax/" method="post" onsubmit="return false;" class="field_edit">
												...
												<td>
													...
													<div class="action_button" title="Delete Field">
														...
														{
															?>
															<form action="/settings/ajax/" method="post" onsubmit="AlertSet.confirm('Are you sure you want to delete <?php echo addslashes($field->get_name())?>?', function(){handleAjaxForm(this, function(){modelUpdateContent()}, function(resp){AlertSet.clear().addJSON(resp).show();});}.bind(this)); return false;">
					...
					<td>
						<div class="action_button" title="Add Field to Group">
							<?php
								...
								{
									?>
									<form id="fieldAdd_<?php echo $group->get_id()?>" action="/settings/ajax/" method="post">
						...
						<div class="action_button" title="Delete Group">
							...
							{
								?>
								<form action="/settings/ajax/" method="post" onsubmit="AlertSet.confirm('Are you sure you want to delete <?php echo addslashes($group->get_name())?>?', function(){handleAjaxForm(this, function(){modelUpdateContent()}, function(resp){AlertSet.clear().addJSON(resp).show();});}.bind(this)); return false;">
...
{
	echo '<br /><strong>Your setting model is empty.</strong>';
}
?>